...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InternNestUser.last_login_at'
        db.add_column(u'UserRegistration_internnestuser', 'last_login_at',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 8, 7, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InternNestUser.last_login_at'
        db.delete_column(u'UserRegistration_internnestuser', 'last_login_at')
